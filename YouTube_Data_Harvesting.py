...
st.title(':blue[ Capstone Project: Youtube Data Harvesting]')


col1, col2 = st.columns(2)
with col1:
    st.header(':black[Data collection]')
    st.write ('(Note:- This Area intends to **collect data** by using channel id and **stored it in the :blue[MongoDB] database**.)')
...
st.header(':black[Channel Data Analysis ]')
